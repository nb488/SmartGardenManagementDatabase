...
INSERT INTO Plant (plant_id, latitude, longitude, radius, is_ready, type_name, section_id)
VALUES (11, 49.2606, -123.2459, 0.18, 1, 'Lettuce', 1);

INSERT INTO Plant (plant_id, latitude, longitude, radius, is_ready, type_name, section_id)
VALUES (12, 49.2607, -123.2461, 0.22, 0, 'Carrot', 1);

INSERT INTO Plant (plant_id, latitude, longitude, radius, is_ready, type_name, section_id)
VALUES (13, 49.2606, -123.2458, 0.28, 1, 'Cucumber', 1);

INSERT INTO Plant (plant_id, latitude, longitude, radius, is_ready, type_name, section_id)
VALUES (14, 49.2607, -123.2459, 0.24, 1, 'Bell Pepper', 1);

INSERT INTO Plant (plant_id, latitude, longitude, radius, is_ready, type_name, section_id)
VALUES (15, 49.2606, -123.2461, 0.19, 0, 'Strawberry', 1);

INSERT INTO Plant (plant_id, latitude, longitude, radius, is_ready, type_name, section_id)
VALUES (16, 49.2608, -123.2461, 0.27, 1, 'Tomato', 2);

INSERT INTO Plant (plant_id, latitude, longitude, radius, is_ready, type_name, section_id)
VALUES (17, 49.2608, -123.2460, 0.16, 1, 'Basil', 2);

INSERT INTO Plant (plant_id, latitude, longitude, radius, is_ready, type_name, section_id)
VALUES (18, 49.2609, -123.2462, 0.21, 0, 'Carrot', 2);

INSERT INTO Plant (plant_id, latitude, longitude, radius, is_ready, type_name, section_id)
VALUES (19, 49.2608, -123.2464, 0.29, 1, 'Cucumber', 2);

INSERT INTO Plant (plant_id, latitude, longitude, radius, is_ready, type_name, section_id)
VALUES (20, 49.2609, -123.2463, 0.23, 0, 'Bell Pepper', 2);
